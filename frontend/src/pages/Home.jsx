...
/**
 * Section IDs used by IntersectionObserver to track active nav item
 * Must match the 'id' attributes on each <section> element
 */
const SECTION_IDS = ['overview', 'analytics', 'skills', 'projects', 'experience', 'goals', 'contact'];
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Create observer to detect which section is in the viewport center
    ...
    return () => observer.disconnect();                       // Cleanup on unmount or reload
  ...
  return (
    ...
    >
      ...
      {/* ─────────────────────────────────────────
          SECTION: Overview — Hero stats + welcome
      ───────────────────────────────────────── */}
      <OverviewSection
        profile={data.profile}
      ...
      {/* ─────────────────────────────────────────
          SECTION: Analytics — KPI cards + charts
      ───────────────────────────────────────── */}
